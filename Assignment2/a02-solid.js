    ...
    window.onload = function init()
    {
      ...
      const radius = .8;
      let A = vec4(0, 0, 0, 1);
      let B = vec4(radius * Math.cos(Math.PI/3), radius * Math.sin(Math.PI/3), 0, 1);
      let C = vec4(radius * Math.cos(2 * Math.PI/3), radius * Math.sin(2 * Math.PI/3), 0, 1);
      let D = vec4(radius * Math.cos(3 * Math.PI/3), radius * Math.sin(3 * Math.PI/3), 0, 1);
      let E = vec4(radius * Math.cos(4 * Math.PI/3), radius * Math.sin(4 * Math.PI/3), 0, 1);
      let F = vec4(radius * Math.cos(5 * Math.PI/3), radius * Math.sin(5 * Math.PI/3), 0, 1);
      let G = vec4(radius * Math.cos(6 * Math.PI/3), radius * Math.sin(6 * Math.PI/3), 0, 1);
      let H = vec4(radius * Math.cos(7 * Math.PI/3), radius * Math.sin(7 * Math.PI/3), 0, 1);
      let R = vec4(radius,0,0,1);
      const vertices = [A, B, C, A, C, D, A, D, E, A, E, F, A, F, G, A, H, R];
      const number_of_vertices = vertices.length;
      ...
      const colors = [X11.Red, X11.Red, X11.Red, X11.Orange, X11.Orange, X11.Orange, X11.Yellow, X11.Yellow, X11.Yellow, X11.Green, X11.Green, X11.Green, X11.Blue, X11.Blue, X11.Blue, X11.Purple, X11.Purple, X11.Purple];
